...
def read_file(file_path, trial_start_zone, custom_fields=None, \
    use_public_id=False, delimiter=None):
    ...
    with open(file_path, "r") as f:
        ...
        ipubid = header.index("Participant Public ID")
        iprivid = header.index("Participant Private ID")
        if use_public_id:
            iparticipant = ipubid
        else:
            iparticipant = iprivid
        ...
        for i, line in enumerate(reader):
            ...
            if line[iparticipant] != current_participant:
                ...
                data[current_participant] = { \
                    ...
                    "public_id":line[ipubid], \
                    "private_id":line[iprivid], \
                    }
